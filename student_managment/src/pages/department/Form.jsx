        ...
        <table style={styles.table}>
          <tbody>
            ...
            <tr>
              ...
              <td style={styles.cell}><Autocomplete type="text" name="duration_type" onChange={onChange}  options={['Year','Month','Days']}  renderInput={(params) => <TextField {...params} label="Duration Type" />} /></td>
            </tr>
            <tr>
